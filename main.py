...
app = FastAPI(title='Backstract Generated APIs - coll-61c01cbcebaf47ddbfc9dffac5959fbe', debug=False,
              docs_url='/jolly-fermi-74d13716eaae11efab560242ac12000576/docs',
              openapi_url='/jolly-fermi-74d13716eaae11efab560242ac12000576/openapi.json')
...
app.include_router(
    router,
    prefix='/jolly-fermi-74d13716eaae11efab560242ac12000576/api',
    tags=['APIs v1']
)
